...
*/
    ...
    PROCEDURE VALIDATE_ROW (
        ...
        -- General: caller bebas kirim pesan apapun
        ...
        -- Helper format pesan master code agar konsisten di semua pemanggilan
        ...
        -- Helper format pesan required field
    ...
    BEGIN
        ...
        r_error_details_json := CASE WHEN v_err THEN v_json ELSE NULL END;
    ...
    PROCEDURE VALIDATE_BY_ID (
        ...
        v_is_valid BOOLEAN;
    BEGIN
        -- Fetch hanya kolom yang divalidasi
        IF p_source = 'STG' THEN
            SELECT AGAMA, STATUS_KAWIN, JEN_KELAMIN, PENDIDIKAN,
                   STATUS_RUMAH, KODE_PROFESI, STATUS_PEKERJAAN,
                   HUBUNGAN, STATUS_INSTANSI, TANGGAL_LAHIR,
                   KEBANGSAAN, PEKERJAAN_BIDANG_USAHA
            INTO   v_rec.agama, v_rec.status_kawin, v_rec.jen_kelamin,
    ...
    PROCEDURE VALIDATE_MASTER (
        ...
        -- Cursor record agar BULK COLLECT tetap efisien
        ...
        v_rec      t_validation_rec;    -- reuse type dari spec
        v_is_valid BOOLEAN;
        v_err_cols VARCHAR2(4000);
        v_err_json CLOB;
    BEGIN
        SELECT ID, AGAMA, STATUS_KAWIN, JEN_KELAMIN, PENDIDIKAN,
               STATUS_RUMAH, KODE_PROFESI, STATUS_PEKERJAAN,
               HUBUNGAN, STATUS_INSTANSI, TANGGAL_LAHIR,
               KEBANGSAAN, PEKERJAAN_BIDANG_USAHA
    ...
    PROCEDURE REVALIDATE_ERROR_ROW (
        ...
        v_err_json   CLOB;
    BEGIN
        -- Cukup delegate ke VALIDATE_BY_ID, tidak perlu mapping manual
        VALIDATE_BY_ID(
            p_id                 => p_err_id,
            p_source             => 'ERR',
