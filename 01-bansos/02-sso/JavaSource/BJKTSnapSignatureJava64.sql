-- DROP JAVA SOURCE DEV."BDKISnapSignatureJava64";
SET DEFINE OFF;

CREATE OR REPLACE AND RESOLVE JAVA SOURCE NAMED DEV."BJKTSnapSignatureJava64"
as import java.nio.charset.StandardCharsets;
    ...
    public class BJKTSnapSignatureJava64 {
