let nilaiRef = apex.item('P1000_REFERENCE').getValue();
prosesCetakPdf('#APP_FILES#', nilaiRef);
...
//     let kodeRef = apex.item('P1000_REFERENCE').getValue();
...
//                 biaya:            (d.BIAYA_TRANSAKSI || 0).toLocaleString('id-ID', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
...
//                 totalSetoran:     (d.TOTAL_TRANSAKSI + d.BIAYA_TRANSAKSI || 0).toLocaleString('id-ID', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
//                 totalSetoranRaw:  (d.TOTAL_TRANSAKSI + d.BIAYA_TRANSAKSI),
